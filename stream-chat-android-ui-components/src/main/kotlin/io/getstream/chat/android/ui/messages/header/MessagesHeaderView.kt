...
public class MessagesHeaderView : ConstraintLayout {
    ...
    private fun configBackButton(attrs: TypedArray) {
        binding.backButtonContainer.apply {
            val shouldShowBackButton = attrs.getBoolean(R.styleable.MessagesHeaderView_streamUiMessagesHeaderShowBackButton, true)
            isVisible = shouldShowBackButton
            isClickable = shouldShowBackButton
        }
        binding.backButtonBadge.apply {
            isVisible =
